...
<div>
    <img  class="w-full h-96 object-cover object-left-top" src="../Assets/img/img1.jpg" alt="">
</div>

<main class="bg-white">
    <section class="p-32 bg-gray-100">
        <h1 class="text-center text-7xl font-bold">TERRE</h1>
        <h2 class="text-center text-5xl font-thin uppercase">Pilates</h2>
    </section>
            ...
            <div class="flex flex-wrap items-center">
                <div class="grow-0 shrink-0 basis-auto w-full lg:w-5/12 mb-12 lg:mb-0 md:px-6">
                    <div class="relative overflow-hidden bg-no-repeat bg-cover rounded-lg shadow-lg" data-mdb-ripple="true"
                        ...
                        <img src="../Assets/img/terre2.jpg" class="w-full"/>
                        <a href="#!">
                                ...
                                <div class="flex justify-center items-center h-full">
                                    <div class="px-6 py-12 md:px-12 text-white text-center">
                                        <h3 class="text-2xl uppercase font-bold mb-6">
                                            La terre en <u style="color: hsl(231, 52.6%, 85%)">mouvement</u>

                                        </h3>
                                        <p style="color: hsl(231, 52.6%, 85%)">
                                            L'ancrage, l'enracinement qui commence en nous même.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="grow-0 shrink-0 basis-auto w-full lg:w-7/12 md:px-6">
                    <div class="flex mb-12">
                        <div class="shrink-0">
                            <div class="p-4 rounded-md shadow-lg bg-black text-white">
                                <i class="fa-solid fa-star"></i>
                            </div>
                        </div>
                        <div class="grow ml-4">
                            <p class="font-bold mb-1">Pilates niv. 1 [ 40 mn]</p>
                            <p class="text-gray-500">
                                Cours au sol sur tapis de niveau débutant.
                                Exercices doux avec une sollicitation articulaire et musculaire modérée, axés sur
                                l’apprentissage et l’intégration des principes de base.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex mb-12">
                        ...
                        <div class="grow ml-4">
                            <p class="font-bold mb-1">Pilates niv. 2 [40 mn]</p>
                            <p class="text-gray-500">
                                Cours au sol de niveau intermédiaire. Exercices nécessitant davantage de qualités de force
                                et de mobilité articulaire ainsi qu’une coordination accrue. Approprié pour les pratiquants
                                jouissant d’une bonne maîtrise des principes de bases et des placements corrects.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex mb-12">
                        ...
                        <div class="grow ml-4">
                            <p class="font-bold mb-1">Conseils et contre-indications</p>
                            <p class="text-gray-500">
                                Ce contenu s’adresse à tous les publics hors pathologies articulaires ou physiologiques
                                lourdes qui feraient l’objet d’un avis de contre-indication médical.

                                La déclinaison en niveau 1 et niveau 2 vous permet de naviguer entre les contenus en
                                fonctions de vos besoins et de votre état du moment.

                                Des options d’amplitude et d’intensité vous sont proposées tout au long du cours et pour
                                chaque niveau : soyez à l’écoute de authentiques
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="grow ml-4">
                            <p class="font-bold mb-1">Laissez-vous guider</p>
                            <p class="text-gray-500">
                                Le Pilates au sol peut être pratiqué librement sans accessoires ou bien optimisé avec
                                l’emploi de petit matériel. Il vous sera parfois proposé d’utiliser celui-ci (petit ballon,
                                élastique de résistance, etc..). Si vous n’en disposez pas, laisser agir votre créativité !
                                Coussins, couvertures, foulards etc. sont les bienvenus en substituts !
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container my-24 px-6 mx-auto">
        ...
        <section class="mb-32 text-gray-800">
            ...
            <div class="container mx-auto text-center lg:text-left">
                <div class="grid lg:grid-cols-2 flex items-center flex-row-reverse lg:flex-row">
                    <div class="mb-12 lg:mb-0">
                        <div
                                class="block rounded-lg shadow-lg px-6 py-12 lg:py-6 xl:py-12 md:px-12 lg:-mr-14"
                                style="background: hsla(0, 0%, 100%, 0.55); backdrop-filter: blur(30px)">
                            <h3 class="text-3xl font-bold mb-3">Les bénéfices du Pilates</h3>

                            <p class="font-bold mt-10 mb-4">Force du Centre</p>
                            <p class="text-gray-500 mb-6">
                                Aussi robuste soit l’écorce d’un arbre, si son tronc est creux, il ne peux tenir debout durablement.

                                Notre priorité en Pilates est de renforcer les muscles profonds du corps :

                                abdos profonds (Transverses) stabilisateurs de l’abdomen
                                plancher pelvien
                                muscles soutient du bas du dos et de l’ensemble de la colonne vertébrale (Multifides)
                                Ce travail confère un centre fort, qui soutient et protège le dos, favorise l’alignement naturel de la posture physiologique et libère les articulations pour une fluidité de mouvements accrue.

                                En Pilates, tout part du centre du corps – aussi appelé « powerhouse ».

                                L’image de la grande roue permet de bien visualiser le rôle qu’il joue comme initiateur de mouvement et source de l’énergie du corps. En effet lorsque la grande roue tourne, le mouvement des nacelles est bien visible à son extrémité mais l’énergie motrice qui lui permet cette rotation vient de son centre et non des nacelles.
                            </p>

                            <p class="font-bold mb-4">Un travail de couturier(e)</p>
                            <p class="text-gray-500 mb-6">
                                Importe ensuite le rééquilibrage des tensions musculaires dont les déséquilibres fréquents provoquent les inconforts que notre époque connait (lombalgies, douleurs cervicales, station assise pénible, etc..).

                                Les zones sous tensions permanente s’étirent et les zones affaiblies sont renforcées.
                            </p>
                            ...
                            <p class="text-gray-500">
                                La pratique du Pilates requiert une concentration totale. Connecter l’esprit au corps à chaque mouvement c’est :

                                rationaliser sa respiration de façon constante
                                visualiser sa posture et ses alignements
                                identifier les réponses musculaires en profondeur
                                porter son attention sur chaque détail
                                Autant d’éléments qui occupent pleinement votre  cerveau durant  le cours, permet de faire le vide dans votre esprit en produisant un effet « méditatif ».

                                Lorsque vous vous sentez submergés par le stress du quotidien, professionnel ou environnemental, vous pouvez faire taire cette cacophonie qui peut paraître incontrôlable.
                            </p>
                            <br>
                            <p class="font-bold mb-4">Quel lien avec le cerveau à moyen terme ?</p>
                            <p class="text-gray-500">
                                Le Pilates, comme toute activité physique, améliore la mémoire immédiate, stimule la créativité et la croissance des cellules cérébrales. Il peut éviter les problèmes de déficit de l’attention chez l’adulte liés au stress, à la fatigue ou à la surconsommation de média 2.0 ! Lutter contre la sédentarité est un acte de développement durable pour conserver un esprit sain dans un corps sain.
                            </p>
                            <br>
                            <p class="font-bold mb-4">
                                Estime de soi
                            ...
                            <p class="text-gray-500">
                                Optimiser le contrôle de ses mouvements, dans une compréhension globale de son corps permet d’améliorer notre confiance. La progression et le gain d’endurance au fil des cours nous fait gagner en assurance.

                                La pratique régulière du Pilates donne un corps élancé, délié, fonctionnel endurant et fort. Ce qui confère une attitude positive et confiante dans la vie de tous les jours.

                                L’amélioration objective de la posture entraîne une perception subjective améliorée de notre image par les autres. En effet, une  personne qui se « tient droite » dans la rue donne toujours l’impression d’être physiquement plus grande, plus « mince » (illusion de -3 kg) et psychologiquement plus sure d’elle voir plus productive (mieux équipée mécaniquement pour aller de l’avant).                        </p>
                            <p class="font-bold mb-4">
                                <br>
                                Conscience de soi
                            </p>
                            <p class="text-gray-500">
                                Dans un quotidien surchargé, accéléré, libérer son corps de ses tensions et retrouver un rythme harmonieux permet de se mettre en accord avec soi-même                        </p>
                        </div>
                    </div>
                    <div>
                        <img src="../Assets/img/terre3.jpg" class="w-full rounded-lg shadow-lg" alt="" />
                    </div>
                </div>
            </div>
            <!-- Jumbotron -->
    ...
    <div style="padding: 56.25% 0 0 0; position: relative;"><iframe style="position: absolute; top: 0; left: 0; width: 50%; height: 50%;" title="Teaser_2-2 .mov" src="https://player.vimeo.com/video/758682556?h=2e974f8fe1&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allowfullscreen="allowfullscreen"></iframe></div>
    <script src="https://player.vimeo.com/api/player.js"></script>
</main>

<!--=========================== FOOTER =============================-->

<footer class="bg-black p-20  shadow m-4 ">
    <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Flowbite™</a>. All Rights Reserved.
    </span>
        <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
            <li>
                <a href="#" class="mr-4 hover:underline md:mr-6 ">Espace membre</a>
            </li>
            <li>
                <a href="#" class="mr-4 hover:underline md:mr-6">S’abonner</a>
            </li>
            <li>
                <a href="#" class="mr-4 hover:underline md:mr-6">Studio Pilates</a>
            </li>
            <li>
                <a href="#" class="mr-4 hover:underline md:mr-6">5ème élément</a>
            </li>
            <li>
                <a href="#" class="hover:underline">Lune</a>
            </li>
        </ul>

        <a href="">Mentions légales & confidentialité - CGU</a>
    </div>
</footer>
</body>
</html>
